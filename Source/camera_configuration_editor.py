...
class CameraConfigurationEditor(QtWidgets.QDialog, Ui_CameraDialog):
    ...
    def __init__(self, configuration, camera_name, parent=None):
        ...
        # Fill the gui text fields with the current parameters from the configuration object.
        ...
        self.input_pixel_size.setText(self.c.conf.get(self.section_name, 'pixel size'))
        self.input_pixel_horizontal.setText(self.c.conf.get(self.section_name, 'pixel horizontal'))
        self.input_pixel_vertical.setText(self.c.conf.get(self.section_name, 'pixel vertical'))
        self.input_repetition_count.setText(self.c.conf.get(self.section_name, 'repetition count'))
        self.input_external_margin.setText(
            self.c.conf.get(self.section_name, 'external margin pixel'))
        self.input_tile_overlap.setText(self.c.conf.get(self.section_name, 'tile overlap pixel'))
